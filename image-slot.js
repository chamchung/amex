...
(() => {
  ...
  function load() {
    ...
    // Standalone/offline seed: a bundled copy can't fetch the sidecar, so an
    // inline script may pre-seed the saved slots on window.__imageSlotsState.
    if (window.__imageSlotsState && typeof window.__imageSlotsState === 'object') {
      slots = Object.assign({}, window.__imageSlotsState, slots);
      loaded = true;
